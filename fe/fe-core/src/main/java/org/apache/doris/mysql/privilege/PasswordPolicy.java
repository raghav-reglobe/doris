...
public class PasswordPolicy {
    ...
    public void checkAccountLockedAndPasswordExpiration(UserIdentity curUser) throws AuthenticationException {
        ...
        try {
            ...
            // Like MySQL proxy authentication it is an AUTHENTICATION check only: a session that
            // already authenticated as a PROXY_PRIV holder may still switch into a locked account
            // (see SuUserCommand); lock the switcher to stop that.
